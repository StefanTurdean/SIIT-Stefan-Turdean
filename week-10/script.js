...
class Life {
  ...
  generateRef() {
    this.ref = document.createElement("div");
    this.ref.classList.add("life");
    this.ref.style.background = "hearth.png"
    this.ref.style.width = `${this.width}rem`
    this.ref.style.height = `${this.height}rem`



    this.lives.push(this.ref)
    document.querySelector("#lifeContainer").appendChild(this.ref)
  }
...
let gameLoop = setInterval(() => {
  ...
  if (life.removeLife(collisionDetection(player, obstacleFactory.obstacles))) {
